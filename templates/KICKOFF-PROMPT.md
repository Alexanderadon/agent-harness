...
|---|---|---|
| 0:00 | `scaffold` | создаёт Next.js-проект, ставит shadcn и зависимости, клонирует agent-harness и раскладывает комплект, коммитит, пушит |
...
| :55, если блок не закрыт | `чекпоинт` | wip-коммит с зелёным typecheck, проверка .env*, пуш, продолжает |
