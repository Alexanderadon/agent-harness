...
Model: AGENT_MODEL from env (default gpt-5-mini) via @ai-sdk/openai. Optional fallback provider via @ai-sdk/openai-compatible when NVIDIA_API_KEY is set. No cached or canned model outputs anywhere in the app.
