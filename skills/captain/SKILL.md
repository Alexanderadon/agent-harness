...
- Waiting for the other laptop (scaffold, SPEC): poll `git pull --rebase --autostash origin main` every 60 seconds for up to 20 minutes, then report and stop.
