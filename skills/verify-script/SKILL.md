...
Write the exact output of one successful `pnpm verify` run to docs/verify.log and of `pnpm test` to docs/test.log (commit both). The PM's agent pastes them into README; never edit README yourself.
